...
// import { getTeamSession } from "../../lib/session"; // adjust path if needed
...
//     if (!session) {
//       setReply("⚠️ No team session found. Please log in first.");
//       return;
//     }

//     const { team_name, password } = session;
...
export default function InterrogationRoom() {
  ...
  async function sendPrompt() {
    ...
    server_session: server_session,
      ...
      if (res.status === 401) {
        setReply("❌ Not logged in. Please go to the login page and try again.");
        return;
      }
